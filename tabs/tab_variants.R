                     ...
                     fluidPage(
                       ...
                       fluidRow(
                         ...
                         valueBoxOutput("value_box_p1_cases", width = 4)
                            ...
                            <p>VOC reporting has been inconsistent across Canada. It is also inconsistent across time, with no VOC data updates on weekends resulting in zero reported cases on these days.
                            As such, we suggest using the 7-day rolling averages of daily report cases and VOC cases, as this allows for the overall trend of VOCs to be visualized.</p>"),
                              fluidRow(box(
